...
<p align="center">
  <img src="https://img.shields.io/badge/Version-2.10.0-brightgreen.svg" alt="Version">
...
9 deterministic rules over the generated `.claude/agents/`, `.claude/skills/` and `.claude/workflows/`:
