...
| [#23](https://github.com/revfactory/harness/pull/23) | feat(skill): add Chinese trigger phrases to the harness skill | [@hyhmrright](https://github.com/hyhmrright) | ADOPTED | Distinct from PR #22: it only widens trigger matching in the `description` fields. Version-independent, and it cannot go stale the way a translated body can. |
